...
public class Persona {
    ...
    public Persona(String nombre, String apellidos) {
        ...
        this.direccion = new SimpleStringProperty("Una dirección...");
        this.ciudad = new SimpleStringProperty("Madrid");
        this.codigoPostal = new SimpleIntegerProperty(28029);
        this.fechaDeNacimiento = new SimpleObjectProperty(LocalDate.of(1984, 10, 31));
